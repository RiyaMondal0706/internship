        ...
        <div class="container-fluid p-4">
            ...
            <div class="card stat-card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <form id="hrForm" action="{{ route('hr.store') }}" method="POST" enctype="multipart/form-data"
                        novalidate> @csrf
                        <div class="row">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-select bg-light border-0" name="designation" required>
                                            ...
                                            <option value = "junier hr manager">Junier HR Manager</option>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select bg-light border-0" id="district_id" name="distric" required>
