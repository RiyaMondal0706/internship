        ...
        <div class="container-fluid p-4">
            ...
            <div class="card stat-card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    <form id="prForm" action="{{ route('mentor.update', $user->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 text-center">
                                ...
                                <div class="mb-3">
                                    ...
                                    <img id="imagePreview"
                                        src="{{ $user->image ? asset('images/mentor/' . $user->image) : asset('upload_images/download.png') }}"
        ...
        $('#department').change(function() {
            ...
            if (department_id) {
                ...
                $.ajax({
                    ...
                    url: "/get-designation/" + department_id,
                    type: "GET",
