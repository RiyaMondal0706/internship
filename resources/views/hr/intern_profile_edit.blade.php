        ...
        <div class="container-fluid p-4">
            ...
            <div class="card stat-card">
                ...
                <div class="card-body p-4">
                    ...
                    <form id="hrForm" action="{{ route('hr.employee.update', $user->id) }}" method="POST"
                        ...
                        <div id="educationCard">
                            ...
                            <h6 class="fw-bold text-primary">Educational Information</h6>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select" name="internship_duration">
                                        ...
                                        <option value="1 Month"
                                            {{ $user->internship_duration == '1 Month' ? 'selected' : '' }}>
                                            1 Month
                                        </option>

                                        <option value="3 Months"
                                            {{ $user->internship_duration == '3 Months' ? 'selected' : '' }}>
                                            3 Months
                                        </option>

                                        <option value="6 Months"
                                            {{ $user->internship_duration == '6 Months' ? 'selected' : '' }}>
                                            6 Months
                                        </option>

                                        <option value="12 Months"
                                            {{ $user->internship_duration == '12 Months' ? 'selected' : '' }}>
                                            12 Months
                                        </option>
