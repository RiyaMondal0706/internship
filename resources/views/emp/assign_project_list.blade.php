...
<body>
    ...
    <script>
        $(document).on("click", ".viewProject", function(e) {
            ...
            $.ajax({
                url: "/Employee/project/details/" + project_id,
                method: "GET",
                xhrFields: {
                    withCredentials: true // important: sends session cookie
                },
                ...
                error: function(xhr) {
                    if (xhr.status === 401) {
                        $("#projectDetails").html(
                            "<div class='text-danger'>Unauthorized — Please login</div>");
                    } else {
                        $("#projectDetails").html(
                            "<div class='text-danger'>Error loading project</div>");
                    }
                }
            });
